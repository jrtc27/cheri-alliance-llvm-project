...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false)
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memmove.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false)
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false) must_preserve_cheri_tags
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memmove.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false) must_preserve_cheri_tags
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false) no_preserve_cheri_tags
  ret void
}
...
; CHECK-NEXT:    ret
entry:
  call void @llvm.memmove.p200.p200.i64(ptr addrspace(200) align 4 %a, ptr addrspace(200) align 4 %b, i64 16, i1 false) no_preserve_cheri_tags
  ret void
}
