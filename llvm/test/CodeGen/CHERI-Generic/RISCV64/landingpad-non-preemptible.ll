...
; CHECK-NEXT:    sc cs0, 0(csp) # 16-byte Folded Spill
...
; CHECK-NEXT:    lc cs0, 0(csp) # 16-byte Folded Reload
; CHECK-NEXT:    cincoffset csp, csp, 32
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB0_2: # %lpad
; CHECK-NEXT:  .Ltmp2:
; CHECK-NEXT:    sext.w s0, a1
; CHECK-NEXT:    ccall __cxa_begin_catch
; CHECK-NEXT:    li a0, 2
; CHECK-NEXT:    bne s0, a0, .LBB0_4
...
; RELOCS-NEXT:   R_RISCV_ADD32 .L0 0x0
