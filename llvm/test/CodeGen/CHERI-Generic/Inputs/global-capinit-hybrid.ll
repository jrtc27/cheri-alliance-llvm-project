...
@IF-RISCV64Bakewell@; RUN:   FileCheck %s --check-prefix=ASM -DPTR_DIRECTIVE=.quad
@IF-RISCV32Bakewell@; RUN:   FileCheck %s --check-prefix=ASM -DPTR_DIRECTIVE=.word
...
@IF-RISCV64Bakewell@; RUN:   FileCheck %s --check-prefix=RELOCS -DINTEGER_RELOC=R_RISCV_64 '-DCAPABILITY_RELOC=R_RISCV_CHERI_CAPABILITY'
@IF-RISCV32Bakewell@; RUN:   FileCheck %s --check-prefix=RELOCS -DINTEGER_RELOC=R_RISCV_32 '-DCAPABILITY_RELOC=R_RISCV_CHERI_CAPABILITY'
...
@global_ptr_const = global ptr inttoptr (iCAPRANGE 1234 to ptr), align @CAP_RANGE_BYTES@
...
@global_cap_inttoptr = global ptr addrspace(200) inttoptr (iCAPRANGE 1234 to ptr addrspace(200)), align @CAP_BYTES@
...
@global_cap_addrspacecast = global ptr addrspace(200) addrspacecast (ptr inttoptr (iCAPRANGE 1234 to ptr) to ptr addrspace(200)), align @CAP_BYTES@
...
@global_cap_nullgep = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE 1234), align @CAP_BYTES@
...
@global_ptr_data = global ptr @extern_data, align @CAP_RANGE_BYTES@
...
@global_ptr_data_past_end = global ptr getelementptr inbounds (i8, ptr @extern_data, iCAPRANGE 1), align @CAP_RANGE_BYTES@
...
@global_ptr_data_two_past_end = global ptr getelementptr (i8, ptr @extern_data, iCAPRANGE 2), align @CAP_RANGE_BYTES@
...
@global_cap_data_addrspacecast = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align @CAP_BYTES@
...
@global_cap_data_addrspacecast_past_end = global ptr addrspace(200) addrspacecast (ptr getelementptr inbounds (i8, ptr @extern_data, iCAPRANGE 1) to ptr addrspace(200)), align @CAP_BYTES@
...
@global_cap_data_addrspacecast_two_past_end = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_data, iCAPRANGE 2) to ptr addrspace(200)), align @CAP_BYTES@
...
@global_cap_data_nullgep = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE ptrtoint (ptr @extern_data to iCAPRANGE)), align @CAP_BYTES@
...
@global_cap_data_nullgep_past_end = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE ptrtoint (ptr getelementptr inbounds (i8, ptr @extern_data, iCAPRANGE 1) to iCAPRANGE)), align @CAP_BYTES@
...
@global_cap_data_nullgep_two_past_end = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE ptrtoint (ptr getelementptr (i8, ptr @extern_data, iCAPRANGE 2) to iCAPRANGE)), align @CAP_BYTES@
...
@global_fnptr = global ptr @extern_fn, align @CAP_RANGE_BYTES@
...
@global_fncap_addrspacecast = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align @CAP_BYTES@
...
@global_fncap_intcap_addrspacecast = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align @CAP_BYTES@
...
@global_fncap_intcap_nullgep = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE ptrtoint (ptr @extern_fn to iCAPRANGE)), align @CAP_BYTES@
...
@global_fncap_addrspacecast_plus_two = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_fn, iCAPRANGE 2) to ptr addrspace(200)), align @CAP_BYTES@
...
@global_fncap_nullgep_plus_two = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, iCAPRANGE ptrtoint (ptr getelementptr (i8, ptr @extern_fn, iCAPRANGE 2) to iCAPRANGE)), align @CAP_BYTES@
