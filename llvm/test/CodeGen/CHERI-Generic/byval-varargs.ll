...
; RUN: sed -e 's/addrspace(200)/addrspace(0)/g' -e 's/p200/p0/g' %s | llc -mtriple riscv64-unknown-freebsd -o - -relocation-model=pic | FileCheck %s --check-prefixes RV64
; RUN: sed -e 's/addrspace(200)/addrspace(0)/g' -e 's/p200/p0/g' %s | llc -mtriple mips64-unknown-freebsd -o - -relocation-model=pic  | FileCheck %s --check-prefixes MIPS
...
entry:
  ...
  %0 = getelementptr inbounds %struct.Foo, ptr addrspace(200) %f, i64 0, i32 0, i64 0
  call void @llvm.lifetime.start.p200(i64 1024, ptr addrspace(200) nonnull %0)
  call void @llvm.memset.p200.i64(ptr addrspace(200) nonnull align 1 dereferenceable(1024) %0, i8 0, i64 1024, i1 false)
  %call = call signext i32 @byref(ptr addrspace(200) nonnull %f)
  %1 = getelementptr inbounds %struct.Foo, ptr addrspace(200) %byval-temp, i64 0, i32 0, i64 0
  call void @llvm.lifetime.start.p200(i64 1024, ptr addrspace(200) nonnull %1)
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) nonnull align 1 dereferenceable(1024) %1, ptr addrspace(200) nonnull align 1 dereferenceable(1024) %0, i64 1024, i1 false)
  %call1 = call signext i32 (i32, ...) @varargs(i32 signext 1024, ptr addrspace(200) nonnull %byval-temp)
  call void @llvm.lifetime.end.p200(i64 1024, ptr addrspace(200) nonnull %1)
  call void @llvm.lifetime.end.p200(i64 1024, ptr addrspace(200) nonnull %0)
  ret i32 %call1
}
...
entry:
  ...
  %0 = getelementptr inbounds %struct.Foo, ptr addrspace(200) %f, i64 0, i32 0, i64 0
  call void @llvm.lifetime.start.p200(i64 1024, ptr addrspace(200) nonnull %0)
  call void @llvm.memset.p200.i64(ptr addrspace(200) nonnull align 8 dereferenceable(1024) %0, i8 0, i64 1024, i1 false)
  %call = call signext i32 @byref(ptr addrspace(200) nonnull %f)
  %call1 = call signext i32 (i32, ...) @varargs(i32 signext 1024, ptr addrspace(200) nonnull byval(%struct.Foo) align 8 %f)
  call void @llvm.lifetime.end.p200(i64 1024, ptr addrspace(200) nonnull %0)
  ret i32 %call1
}
...
declare signext i32 @byref(ptr addrspace(200)) local_unnamed_addr addrspace(200)
