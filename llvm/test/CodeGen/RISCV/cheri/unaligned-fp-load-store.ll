...
declare i32 @printf(ptr addrspace(200), ...) addrspace(200)

define i32 @unaligned_float(ptr addrspace(200) nocapture readonly %arg, float %newval) unnamed_addr addrspace(200) nounwind {
...
bb:
  %unaligned_load = load float, ptr addrspace(200) %arg, align 1
  %ext = fpext float %unaligned_load to double
  %ret = tail call i32 (ptr addrspace(200), ...) @printf(ptr addrspace(200) nonnull dereferenceable(1) undef, double %ext)
  store float %newval, ptr addrspace(200) %arg, align 1
  ret i32 %ret
}

define i32 @unaligned_double(ptr addrspace(200) nocapture readonly %arg, double %newval) unnamed_addr addrspace(200) nounwind {
...
; RV64IFXCHERI-NEXT:    ret
bb:
  %unaligned_load = load double, ptr addrspace(200) %arg, align 2
  %ret = tail call i32 (ptr addrspace(200), ...) @printf(ptr addrspace(200) nonnull dereferenceable(1) undef, double %unaligned_load)
  store double %newval, ptr addrspace(200) %arg, align 2
  ret i32 %ret
}

define i32 @unaligned_fp128(ptr addrspace(200) nocapture readonly %arg, fp128 %newval) unnamed_addr addrspace(200) nounwind {
...
; RV64IFXCHERI-NEXT:    ret
bb:
  %unaligned_load = load fp128, ptr addrspace(200) %arg, align 4
  %trunc = fptrunc fp128 %unaligned_load to double
  %ret = tail call i32 (ptr addrspace(200), ...) @printf(ptr addrspace(200) nonnull dereferenceable(1) undef, double %trunc)
  store fp128 %newval, ptr addrspace(200) %arg, align 4
  ret i32 %ret
}

define i32 @unaligned_int(ptr addrspace(200) nocapture readonly %arg) unnamed_addr addrspace(200) nounwind {
...
; RV64IFXCHERI-NEXT:    ret
bb:
  %unaligned_load = load i32, ptr addrspace(200) %arg, align 1
  %ret = tail call i32 (ptr addrspace(200), ...) @printf(ptr addrspace(200) nonnull dereferenceable(1) undef, i32 %unaligned_load)
  store i32 1, ptr addrspace(200) %arg, align 1
  ret i32 %ret
}
