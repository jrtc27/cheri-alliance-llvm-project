...
; soft float ABI
define dso_local double @ddc_fld(ptr %a) nounwind {
; CHECK-ILP32-LABEL: ddc_fld:
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    addi sp, sp, -16
; CHECK-ILP32-NEXT:    fld fa5, 0(a0)
; CHECK-ILP32-NEXT:    fld fa4, 24(a0)
...
; CHECK-ILP32D:       # %bb.0:
; CHECK-ILP32D-NEXT:    fld fa5, 0(a0)
; CHECK-ILP32D-NEXT:    fld fa4, 24(a0)
...
; CHECK-IL32PC64-NEXT:    lw a0, 8(csp)
; CHECK-IL32PC64-NEXT:    lw a1, 12(csp)
; CHECK-IL32PC64-NEXT:    cincoffset csp, csp, 16
...
; CHECK-IL32PC64D-NEXT:    cincoffset csp, csp, 16
; CHECK-IL32PC64D-NEXT:    ret
;
; CHECK-LP64-LABEL: ddc_fld:
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    fld fa5, 0(a0)
; CHECK-LP64-NEXT:    fld fa4, 24(a0)
; CHECK-LP64-NEXT:    fadd.d fa5, fa5, fa4
; CHECK-LP64-NEXT:    fmv.x.d a0, fa5
; CHECK-LP64-NEXT:    ret
;
; CHECK-LP64D-LABEL: ddc_fld:
; CHECK-LP64D:       # %bb.0:
; CHECK-LP64D-NEXT:    fld fa5, 0(a0)
; CHECK-LP64D-NEXT:    fld fa4, 24(a0)
; CHECK-LP64D-NEXT:    fadd.d fa0, fa5, fa4
...
; CHECK-L64PC128-NEXT:    fmv.d.x fa5, a1
; CHECK-L64PC128-NEXT:    fmv.d.x fa4, a0
; CHECK-L64PC128-NEXT:    fadd.d fa5, fa5, fa4
; CHECK-L64PC128-NEXT:    fmv.x.d a0, fa5
...
; CHECK-L64PC128D-NEXT:    fmv.d.x fa5, a1
; CHECK-L64PC128D-NEXT:    fmv.d.x fa4, a0
; CHECK-L64PC128D-NEXT:    fadd.d fa0, fa5, fa4
; CHECK-L64PC128D-NEXT:    ret
  %1 = load double, ptr %a
...
define dso_local void @ddc_fsd(ptr %a, double %b, double %c) nounwind {
...
; CHECK-ILP32-NEXT:    fadd.d fa5, fa4, fa5
; CHECK-ILP32-NEXT:    fsd fa5, 0(a0)
; CHECK-ILP32-NEXT:    fsd fa5, 64(a0)
; CHECK-ILP32-NEXT:    addi sp, sp, 16
; CHECK-ILP32-NEXT:    ret
;
; CHECK-ILP32D-LABEL: ddc_fsd:
; CHECK-ILP32D:       # %bb.0:
; CHECK-ILP32D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-ILP32D-NEXT:    fsd fa5, 0(a0)
; CHECK-ILP32D-NEXT:    fsd fa5, 64(a0)
; CHECK-ILP32D-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: ddc_fsd:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    cincoffset csp, csp, -16
; CHECK-IL32PC64-NEXT:    sw a3, 8(csp)
; CHECK-IL32PC64-NEXT:    sw a4, 12(csp)
; CHECK-IL32PC64-NEXT:    fld fa5, 8(csp)
; CHECK-IL32PC64-NEXT:    sw a1, 8(csp)
; CHECK-IL32PC64-NEXT:    sw a2, 12(csp)
; CHECK-IL32PC64-NEXT:    fld fa4, 8(csp)
; CHECK-IL32PC64-NEXT:    fadd.d fa5, fa4, fa5
; CHECK-IL32PC64-NEXT:    fsd fa5, 8(csp)
...
; CHECK-IL32PC64D:       # %bb.0:
; CHECK-IL32PC64D-NEXT:    cincoffset csp, csp, -16
; CHECK-IL32PC64D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-IL32PC64D-NEXT:    fsd fa5, 8(csp)
; CHECK-IL32PC64D-NEXT:    lw a1, 8(csp)
; CHECK-IL32PC64D-NEXT:    lw a2, 12(csp)
...
; CHECK-LP64-NEXT:    fsd fa5, 0(a0)
; CHECK-LP64-NEXT:    fsd fa5, 64(a0)
; CHECK-LP64-NEXT:    ret
;
; CHECK-LP64D-LABEL: ddc_fsd:
; CHECK-LP64D:       # %bb.0:
; CHECK-LP64D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-LP64D-NEXT:    fsd fa5, 0(a0)
; CHECK-LP64D-NEXT:    fsd fa5, 64(a0)
; CHECK-LP64D-NEXT:    ret
;
...
; CHECK-L64PC128D:       # %bb.0:
; CHECK-L64PC128D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-L64PC128D-NEXT:    fmv.x.d a1, fa5
...
; soft float ABI
define dso_local double @cap_fld(ptr addrspace(200) %a) nounwind {
...
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    cincoffset csp, csp, -16
; CHECK-IL32PC64-NEXT:    fld fa5, 0(ca0)
; CHECK-IL32PC64-NEXT:    fld fa4, 24(ca0)
; CHECK-IL32PC64-NEXT:    fadd.d fa5, fa5, fa4
; CHECK-IL32PC64-NEXT:    fsd fa5, 8(csp)
; CHECK-IL32PC64-NEXT:    lw a0, 8(csp)
; CHECK-IL32PC64-NEXT:    lw a1, 12(csp)
...
; CHECK-IL32PC64D:       # %bb.0:
; CHECK-IL32PC64D-NEXT:    fld fa5, 0(ca0)
; CHECK-IL32PC64D-NEXT:    fld fa4, 24(ca0)
; CHECK-IL32PC64D-NEXT:    fadd.d fa0, fa5, fa4
; CHECK-IL32PC64D-NEXT:    ret
;
...
; CHECK-LP64-NEXT:    fmv.d.x fa5, a1
; CHECK-LP64-NEXT:    fmv.d.x fa4, a0
; CHECK-LP64-NEXT:    fadd.d fa5, fa5, fa4
; CHECK-LP64-NEXT:    fmv.x.d a0, fa5
; CHECK-LP64-NEXT:    ret
;
...
; CHECK-LP64D-NEXT:    fmv.d.x fa5, a1
; CHECK-LP64D-NEXT:    fmv.d.x fa4, a0
; CHECK-LP64D-NEXT:    fadd.d fa0, fa5, fa4
; CHECK-LP64D-NEXT:    ret
;
; CHECK-L64PC128-LABEL: cap_fld:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    fld fa5, 0(ca0)
; CHECK-L64PC128-NEXT:    fld fa4, 24(ca0)
; CHECK-L64PC128-NEXT:    fadd.d fa5, fa5, fa4
; CHECK-L64PC128-NEXT:    fmv.x.d a0, fa5
; CHECK-L64PC128-NEXT:    ret
;
...
; CHECK-L64PC128D:       # %bb.0:
; CHECK-L64PC128D-NEXT:    fld fa5, 0(ca0)
; CHECK-L64PC128D-NEXT:    fld fa4, 24(ca0)
; CHECK-L64PC128D-NEXT:    fadd.d fa0, fa5, fa4
; CHECK-L64PC128D-NEXT:    ret
  %1 = load double, ptr addrspace(200) %a
  %2 = getelementptr double, ptr addrspace(200) %a, i32 3
  %3 = load double, ptr addrspace(200) %2
  %4 = fadd double %1, %3
  ret double %4
}
...
; Uses %b and %c in an FP op to ensure floating point registers are used, even
; for the soft float ABI
define dso_local void @cap_fsd(ptr addrspace(200) %a, double %b, double %c) nounwind {
...
; CHECK-ILP32D-NEXT:    addi sp, sp, -16
; CHECK-ILP32D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-ILP32D-NEXT:    fsd fa5, 8(sp)
...
; CHECK-IL32PC64-NEXT:    fld fa4, 8(csp)
; CHECK-IL32PC64-NEXT:    fadd.d fa5, fa4, fa5
; CHECK-IL32PC64-NEXT:    fsd fa5, 0(ca0)
; CHECK-IL32PC64-NEXT:    fsd fa5, 64(ca0)
; CHECK-IL32PC64-NEXT:    cincoffset csp, csp, 16
; CHECK-IL32PC64-NEXT:    ret
;
...
; CHECK-IL32PC64D:       # %bb.0:
; CHECK-IL32PC64D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-IL32PC64D-NEXT:    fsd fa5, 0(ca0)
; CHECK-IL32PC64D-NEXT:    fsd fa5, 64(ca0)
; CHECK-IL32PC64D-NEXT:    ret
;
...
; CHECK-LP64D:       # %bb.0:
; CHECK-LP64D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-LP64D-NEXT:    fmv.x.d a1, fa5
...
; CHECK-L64PC128-NEXT:    fmv.d.x fa4, a1
; CHECK-L64PC128-NEXT:    fadd.d fa5, fa4, fa5
; CHECK-L64PC128-NEXT:    fsd fa5, 0(ca0)
; CHECK-L64PC128-NEXT:    fsd fa5, 64(ca0)
; CHECK-L64PC128-NEXT:    ret
;
; CHECK-L64PC128D-LABEL: cap_fsd:
; CHECK-L64PC128D:       # %bb.0:
; CHECK-L64PC128D-NEXT:    fadd.d fa5, fa0, fa1
; CHECK-L64PC128D-NEXT:    fsd fa5, 0(ca0)
; CHECK-L64PC128D-NEXT:    fsd fa5, 64(ca0)
; CHECK-L64PC128D-NEXT:    ret
  %1 = fadd double %b, %c
  store double %1, ptr addrspace(200) %a
  %2 = getelementptr double, ptr addrspace(200) %a, i32 8
  store double %1, ptr addrspace(200) %2
  ret void
}
