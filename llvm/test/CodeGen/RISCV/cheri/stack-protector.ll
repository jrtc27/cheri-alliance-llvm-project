...
; IL32PC64-NEXT:    auipc cs0, %pcrel_hi(__stack_chk_guard)
; IL32PC64-NEXT:    cincoffset cs0, cs0, %pcrel_lo(.LBB0_3)
...
; L64PC128-NEXT:    auipc cs0, %pcrel_hi(__stack_chk_guard)
; L64PC128-NEXT:    cincoffset cs0, cs0, %pcrel_lo(.LBB0_3)
