...
# CHECK-ASM: auipc ca0, %tls_gd_pcrel_hi(x)
# CHECK-OBJ: auipc ca0, 0
...
clc.tls.gd ca0, x
# CHECK-ASM: call __tls_get_addr
# CHECK-OBJ: auipc cra, 0
# CHECK-OBJ: jalr cra
