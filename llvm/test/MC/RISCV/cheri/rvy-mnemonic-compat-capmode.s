...
label:
# CHECK-32: auipc   cra, %got_pcrel_hi(label) # encoding: [0x97,0bAAAA0000,A,A]
# CHECK-32: lc cra, %pcrel_lo(.Lpcrel_hi0)(cra) # encoding: [0x83,0xb0,0bAAAA0000,A]
# CHECK-64: auipc   cra, %got_pcrel_hi(label) # encoding: [0x97,0bAAAA0000,A,A]
# CHECK-64: lc      cra, %pcrel_lo(.Lpcrel_hi0)(cra) # encoding: [0x8f,0xa0,0bAAAA0000,A]
lgy x1, label
# CHECK-32: auipc   cra, %pcrel_hi(label) # encoding: [0x97,0bAAAA0000,A,A]
# CHECK-32: cincoffset cra, cra, %pcrel_lo(.Lpcrel_hi1) # encoding: [0xdb,0x90,0bAAAA0000,A]
# CHECK-64: auipc   cra, %pcrel_hi(label) # encoding: [0x97,0bAAAA0000,A,A]
