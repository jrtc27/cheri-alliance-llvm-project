...
public:
  ...
  void printRegName(const MCSubtargetInfo &STI, raw_ostream &O, MCRegister Reg);
  ...
  void printSpecialCapRegister(const MCInst *MI, unsigned OpNo,
                               const MCSubtargetInfo &STI, raw_ostream &O);
  void printCheriCSRSystemRegister(const MCInst *MI, unsigned OpNo,
                               const MCSubtargetInfo &STI, raw_ostream &O);
  ...
  void printRegReg(const MCInst *MI, unsigned OpNo, const MCSubtargetInfo &STI,
                   raw_ostream &O);
  void printCSetBndImm(const MCInst *MI, unsigned OpNo,
                      const MCSubtargetInfo &STI, raw_ostream &O);
  ...
  void printCustomAliasOperand(const MCInst *MI, uint64_t Address,
                               ...
                               const MCSubtargetInfo &STI, raw_ostream &O);
  static const char *getRegisterName(const MCSubtargetInfo &STI,
                                     MCRegister Reg);
