...
// CHECK-NEXT:     zish4add             0.9       'Zish4add' (Address Generation Instructions for wide-pointers.)
...
// CHECK-NEXT:     zcherihybrid         0.9       'ZCheriHybrid' (Backwards compatibility for 'zcheripurecap' with RISCV)
// CHECK-NEXT:     zcherilevels         0.9       'ZCheriLevels' (Extension for Capability Levels)
// CHECK-NEXT:     zcheripte            0.9       'ZCheriPTE' (CHERI Page-Based Virtual-Memory)
// CHECK-NEXT:     zcheripurecap        0.9       'ZCheriPureCap' (CHERI aware Instructions)
...
// CHECK-NEXT:     zyhybrid             0.99      'Zyhybrid' (CHERI Pointer Modes)
// CHECK-NEXT:     zylevels1b           0.99      'Zylevels1b' (CHERI 2-Level Information Flow Control)
