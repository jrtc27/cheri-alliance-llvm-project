...
QualType ASTContext::getVariableArrayType(
  ...
  auto *New = new (*this, alignof(VariableArrayType)) VariableArrayType(
      EltTy, Canon, NumElts, ASM, IndexTypeQuals, Brackets, PIK);
...
QualType ASTContext::getDependentSizedArrayType(
    QualType elementType, Expr *numElements, ArraySizeModifier ASM,
...
QualType ASTContext::getIncompleteArrayType(
    QualType elementType, ArraySizeModifier ASM, unsigned elementTypeQuals,
    std::optional<PointerInterpretationKind> PIK) const {
  llvm::FoldingSetNodeID ID;
