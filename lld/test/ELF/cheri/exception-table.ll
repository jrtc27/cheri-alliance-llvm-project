...
; HEADERS-NEXT: 03     .gcc_except_table .relro_padding
; HEADERS-NEXT: 04     .data .captable .got .pad.cheri.pcc
; HEADERS-NEXT: 05     .dynamic
; HEADERS-NEXT: 06     .gcc_except_table .relro_padding
; HEADERS-NEXT: 07     __cap_relocs .eh_frame .text .gcc_except_table .relro_padding .data .captable .got .pad.cheri.pcc {{$}}
; HEADERS-NEXT: 08
