...
# RUN: ld.lld -z cheri-riscv-v9 --shared %t/small-text.o -o %t/small-text.so
# RUN: ld.lld -z cheri-riscv-v9 --shared %t/big-text.o -o %t/big-text.so
# RUN: ld.lld -z cheri-riscv-v9 --shared %t/text-rodata.o -o %t/text-rodata.so
# RUN: ld.lld -z cheri-riscv-v9 --shared %t/rodata-only.o -o %t/rodata-only.so
# RUN: ld.lld -z cheri-riscv-v9 --shared %t/plt.o -o %t/plt.so
