...
# RUN: llvm-objdump --no-print-imm-hex -d --no-show-raw-insn %t.32 | FileCheck --check-prefix=DIS %s
...
# RUN: llvm-objdump --no-print-imm-hex -d --no-show-raw-insn %t.64 | FileCheck --check-prefix=DIS %s
...
# RELOC32-NEXT:   0x12000 IFUNC - 0x11000 [0x11000-0x12200]
# RELOC32-NEXT:   0x12200 FUNC - 0x11010 [0x11000-0x12200]
# RELOC32-NEXT: }
...
# RELOC64-NEXT:   0x12000 IFUNC - 0x11000 [0x11000-0x12010]
# RELOC64-NEXT:   0x12010 FUNC - 0x11010 [0x11000-0x12010]
# RELOC64-NEXT: }
